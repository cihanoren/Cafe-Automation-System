...
namespace No1
{
    internal class Baglanti
    {
        ...
        public static float KAR_TOPLAMI_1;
        public static float SATIS_CIROSU_1;
        public static float SATIS_ADETI_1;
        public static float ISLENMIS_MAL_1;
        public static float KAR_TOPLAMI_2;
        public static float SATIS_CIROSU_2;
        public static float SATIS_ADETI_2;
        public static float ISLENMIS_MAL_2;

        public static float KAR_TOPLAMI_3;
        public static float SATIS_CIROSU_3;
        public static float SATIS_ADETI_3;
        public static float ISLENMIS_MAL_3;
    ...
    public class Veritabani
    {
        ...
        public static DataTable VeriGetir(string tabloAdi, string sorguSart, string sorguParametreAdi, string sorguParametreDeger,string kısıtlama)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(Baglanti.baglanti.ConnectionString))
                {
                    ...
                    string query = $"SELECT {kısıtlama} FROM {tabloAdi} WHERE {sorguSart} LIKE @{sorguParametreAdi}";
        ...
        public static void Sil(string tabloAdi, string idParametreAdi, object seciliID,string neyegore)
        {
            try
            {
                ...
                string kontrolSorgusu = $"SELECT COUNT(*) FROM {tabloAdi} WHERE {neyegore} = @{idParametreAdi}";
                ...
                using (SqlCommand kontrolKomut = new SqlCommand(kontrolSorgusu, Baglanti.baglanti))
                {
                    ...
                    if (kayitSayisi > 0)
                    {
                        ...
                        string silSorgusu = $"DELETE FROM {tabloAdi} WHERE {neyegore} = @{idParametreAdi}";
        ...
        {
            try
            {//ayarlanmamış sile göre ayarlanacak
                Baglanti.baglanti.Open();
