...
namespace No1
{
    public partial class BarSatilan : Form
    {
        public BarSatilan()
        {
            InitializeComponent();
        ...
        private void BarSatilan_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void listele()
        {
            ...
            DataTable dt = Veritabani.Listele("bar_satilanurunhacmi", dataGridView1, "", "");
        ...
        private void label_gsoter()
        {
            ...
            try
            {
                ...
                if (ciro_ != DBNull.Value)
                {
                    ...
                    Baglanti.SATIS_CIROSU_1 = ciro_1;
                ...
                if (toplamo != DBNull.Value)
                {
                    ...
                    Baglanti.SATIS_ADETI_1 = toplam_;
                ...
                if (imal != DBNull.Value)
                {
                    ...
                    Baglanti.ISLENMIS_MAL_1 = islenmismal;
        ...
        private void bar_comboBox()
        {
            ...
            SqlCommand goster = new SqlCommand(@"
                ...
                FROM bar_recete AS ir1 
                WHERE toplammaliyet = (
                    SELECT MAX(toplammaliyet) 
                    FROM bar_recete AS ir2 
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand getir = new SqlCommand("SELECT toplammaliyet FROM bar_recete WHERE id = @pid", Baglanti.baglanti);
        ...
        private void kaydet_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT satilanurun FROM bar_satilanurunhacmi", Baglanti.baglanti);
            ...
            if (!kontrol.Contains(listele_1))
            {
                ...
                try
                {
                    ...
                    SqlCommand komut = new SqlCommand("SELECT toplammaliyet FROM bar_recete WHERE id = @urunid", Baglanti.baglanti);
                    ...
                    SqlCommand ekle = new SqlCommand("INSERT INTO bar_satilanurunhacmi(satilanurun, satisadet, maliyetfiyati, satisfiyati, satisadetciro, urunsatisindankalankar, satismaliyetfarki) VALUES(@psatilanurun, @psatisadet, @pmaliyetfiyati, @psatisfiyati, @psatisadetciro, @purunsatisindankalankar, @psatisvemaliyetfarki)", Baglanti.baglanti);
            ...
            else
            {
               ...
               */
                ...
                try
                {
                    ...
                    SqlCommand ekle = new SqlCommand("UPDATE bar_satilanurunhacmi SET satisadet = @psatisadet, maliyetfiyati = @pmaliyetfiyati, satisfiyati = @psatisfiyati, satisadetciro = @psatisadetciro, urunsatisindankalankar = @purunsatisindankalankar, satismaliyetfarki = @psatisvemaliyetfarki WHERE satilanurun = @psatilanurun", Baglanti.baglanti);
        ...
        private void silbt_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                Veritabani.Sil("bar_satilanurunhacmi", "id", seciliID, "id");
